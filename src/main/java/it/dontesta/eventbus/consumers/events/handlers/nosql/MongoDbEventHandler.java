 ...
 *
 * <p>
 * Questo componente è responsabile di processare gli eventi/messaggi veicolati dal Dispatcher
 ...
 *
 * <p>
 * La registrazione avviene all'avvio dell'applicazione tramite l'annotazione {@code @Observes}
 ...
 *
 * <p>
 * L'indicazione dell'indirizzo virtuale dell'evento per l'Event Handler è definita nel parametro
...
public class MongoDbEventHandler {
    ...
    @ConfigProperty(name = "app.eventbus.consumer.event.handler.nosql.mongodb.database.name", defaultValue = "audit")
    String databaseName;

    @ConfigProperty(name = "app.eventbus.consumer.event.handler.nosql.mongodb.database.collection", defaultValue = "jax-rs-requests")
     ...
     *
     * <p>
     * Il metodo riceve il messaggio dell'evento e crea un documento
     ...
     *
     * <p>
     * In questo caso si considerano solo due componenti sorgente: HttpRequestConsumer e
