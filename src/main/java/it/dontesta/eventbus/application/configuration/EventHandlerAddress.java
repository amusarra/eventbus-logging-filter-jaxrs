 ...
 *
 * <p>
 * Questo componente è usato per definire l'indirizzo dell'event handler e se è abilitato o meno
...
public class EventHandlerAddress {
    ...
    public static boolean isAddressAndExistsEnabled(List<EventHandlerAddress> eventHandlerAddresses,
        ...
        return eventHandlerAddresses.stream()
                .anyMatch(eventHandlerAddress -> eventHandlerAddress.getAddress().equals(address) &&
