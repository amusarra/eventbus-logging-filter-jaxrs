 ...
 *
 * <p>
 * Questo converter è utilizzato in modo specifico per convertire le proprietà di configurazione
 ...
 *
 * <p>
 * Il formato della stringa è il seguente: {@code address=address,enabled=enabled} dove address è
